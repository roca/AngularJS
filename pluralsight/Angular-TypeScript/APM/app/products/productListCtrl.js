    ...
    (function (producList) {
        var ProductListCtrl = (function () {
            function ProductListCtrl() {
                ...
                var newProduct = new app.domain.Product(3, "Saw", "TBX-002", new Date(2002, 3, 1), "15-inch steel blade hand saw", 16.95, "http://openclipart.org/image/300px/svg_to_png/27070/egore911_saw.png");
